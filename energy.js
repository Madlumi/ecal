...
class House {
  constructor(type, Atemp, location) {
    ...
    this.foot4  = false;     // Footnote-4 flag
    this.foot5  = false;     // Footnote-5 flag
  }
}
...
function printHouse(house) {
  ...
  console.log(`Foot4: ${house.foot4 ? "Yes" : "No"}   Foot5: ${house.foot5 ? "Yes" : "No"}`);
...
(function main() {
  ...
  h.foot4    = true;   // footnote-4 applies
  h.foot5    = true;   // footnote-5 applies
